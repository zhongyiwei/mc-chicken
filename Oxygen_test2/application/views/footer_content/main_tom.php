<!--     
    Author     : Wang Qianhua
    Description: Used to generate the page that displays Terms of Use for using Oxygen
-->
...
<div id="page">
    <div id="content_sub">
        <div class="post">
            <h2 class="title" id="WMS">Terms Of Use </h2>
            <div class="entry">                
                <p>
                  
                    Welcome to our website. If you continue to browse and use this website, you are agreeing to comply with and be bound by 
                    the following terms and conditions of use, which together with our privacy policy govern [business name]'s relationship 
                    with you in relation to this website. If you disagree with any part of these terms and conditions, please do not use our
                    website.
                </p>
                <p>
