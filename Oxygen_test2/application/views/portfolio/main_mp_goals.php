...
<div id="page">
    <div id="content_sub">
        <div class="post">
         ...
         <div class="post">
            <h2 class="title" id="FAMILY">Your Family Goal</h2>
            <div class="entry">
                ...
                <p>A coat of arms is a distinctive heraldic design on a tunic used to cover and protect armor, but the term is more broadly applied to mean a full heraldic achievement which consists of a shield and certain accessories. In either sense, the design is a symbol unique to a person, family, corporation, or state. Such displays are also commonly called armorial bearings, armorial devices, heraldic devices, or arms.</p>
                        ...
                        <h2 class="title" id="CAREER">Your Career Goal</h2>
            <div class="entry">
                <h2>The Coat of Arms: </h2>
                <p>A coat of arms is a distinctive heraldic design on a tunic used to cover and protect armor, but the term is more broadly applied to mean a full heraldic achievement which consists of a shield and certain accessories. In either sense, the design is a symbol unique to a person, family, corporation, or state. Such displays are also commonly called armorial bearings, armorial devices, heraldic devices, or arms.</p>
            </div>
                        
            <h2 class="title" id="FINANCIAL">Your Financial Goal</h2>
            <div class="entry">
                <h2>The Coat of Arms: </h2>
                <p>A coat of arms is a distinctive heraldic design on a tunic used to cover and protect armor, but the term is more broadly applied to mean a full heraldic achievement which consists of a shield and certain accessories. In either sense, the design is a symbol unique to a person, family, corporation, or state. Such displays are also commonly called armorial bearings, armorial devices, heraldic devices, or arms.</p>
            </div>
            <h2 class="title" id="Social">Your Social Goal</h2>
            <div class="entry">
                <h2>The Coat of Arms: </h2>
                <p>A coat of arms is a distinctive heraldic design on a tunic used to cover and protect armor, but the term is more broadly applied to mean a full heraldic achievement which consists of a shield and certain accessories. In either sense, the design is a symbol unique to a person, family, corporation, or state. Such displays are also commonly called armorial bearings, armorial devices, heraldic devices, or arms.</p>
            </div>
            <h2 class="title" id="CAREER">Your Spiritual Goal</h2>
            <div class="entry">
                <h2>The Coat of Arms: </h2>
                <p>A coat of arms is a distinctive heraldic design on a tunic used to cover and protect armor, but the term is more broadly applied to mean a full heraldic achievement which consists of a shield and certain accessories. In either sense, the design is a symbol unique to a person, family, corporation, or state. Such displays are also commonly called armorial bearings, armorial devices, heraldic devices, or arms.</p>
            </div>
             <h2 class="title" id="CAREER">Your Educational Goal</h2>
            <div class="entry">
                <h2>The Coat of Arms: </h2>
                <p>A coat of arms is a distinctive heraldic design on a tunic used to cover and protect armor, but the term is more broadly applied to mean a full heraldic achievement which consists of a shield and certain accessories. In either sense, the design is a symbol unique to a person, family, corporation, or state. Such displays are also commonly called armorial bearings, armorial devices, heraldic devices, or arms.</p>
            </div>
            ...
            <h2 class="title" id="VALUE">Your Physical Goal</h2>
            <div class="entry">
                <h2>The Coat of Arms: </h2>
                <p>A coat of arms is a distinctive heraldic design on a tunic used to cover and protect armor, but the term is more broadly applied to mean a full heraldic achievement which consists of a shield and certain accessories. In either sense, the design is a symbol unique to a person, family, corporation, or state. Such displays are also commonly called armorial bearings, armorial devices, heraldic devices, or arms.</p>
