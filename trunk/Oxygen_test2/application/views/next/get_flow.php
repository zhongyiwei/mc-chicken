...
<img width="80px" height="80px" src="<?php echo base_url();?>web_images/flowchart/Mission-Green.png"></img></a>
<?php } else{ ?>
<img width="80px" height="80px" src="<?php echo base_url();?>web_images/flowchart/Mission-Blue (PNG).png"></img></a>
<?php } ?>
<img width="60px" height="60px" src="<?php echo base_url();?>web_images/flowchart/arrow.png"></img>
<?php if($checkValue->num_rows() >0){ ?>
<a href="<?php echo base_url();?>index.php/home/determineValue/"><img width="80px" height="80px" src="<?php echo base_url();?>web_images/flowchart/Value-Green(PNG).png"></a>
<?php } 
else if($checkMission->num_rows() >0){ ?>
<a href="<?php echo base_url();?>index.php/home/determineValue/"><img width="80px" height="80px" src="<?php echo base_url();?>web_images/flowchart/Value-Blue (PNG).png"></a> <?php
} else { ?>
...
<a href="<?php echo base_url();?>index.php/home/goal/"><img width="80px" height="80px" src="<?php echo base_url();?>web_images/flowchart/Goals-Green(PNG).png"></a>
<?php } 
else if($checkValue->num_rows() >0){ ?>
<a href="<?php echo base_url();?>index.php/home/goal/"><img width="80px" height="80px" src="<?php echo base_url();?>web_images/flowchart/Goals-Blue(PNG).png"></a> <?php
} else { ?>
...
<a href="<?php echo base_url();?>index.php/home/activity_page/"><img width="80px" height="80px" src="<?php echo base_url();?>web_images/flowchart/Activity-Green(PNG).png"></a>
<?php } 
else if($checkGoal->num_rows() >0){ ?>
<a href="<?php echo base_url();?>index.php/home/activity_page/"><img width="80px" height="80px" src="<?php echo base_url();?>web_images/flowchart/Activity-Blue(PNG).png"></a> <?php
} else { ?>
...
<a href="<?php echo base_url();?>index.php/home/resilience/"><img width="80px" height="80px" src="<?php echo base_url();?>web_images/flowchart/Resilience-Green(PNG).png"></a>
<?php } 
else if($checkActivityStatus==true){ ?>
<a href="<?php echo base_url();?>index.php/home/resilience/"><img width="80px" height="80px" src="<?php echo base_url();?>web_images/flowchart/Resilience-Blue(PNG).png"></a> <?php
} else { ?>
...
<a href="<?php echo base_url();?>index.php/home/portfolio_coa_motto/#MS"><img width="80px" height="80px" src="<?php echo base_url();?>web_images/flowchart/Coat of Arms-Green(PNG).png"></a>
<?php } 
else if($checkResilience->num_rows()>0){ ?>
<a href="<?php echo base_url();?>index.php/home/portfolio_coa_motto/#MS"><img width="80px" height="80px" src="<?php echo base_url();?>web_images/flowchart/Coat of Arms-Blue(PNG).png"></a> <?php
} else { ?>
