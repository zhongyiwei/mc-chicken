<!--     
    Author     : Wang Qianhua
    Description: Used to generate the page and the function which display user`s coat of arms after he set his own.
-->
...
<div id="page">
    ...
    <div id="content_sub">
        <div class="post">
            ...
            <img align:left alt="Generated Coat of Arm" src="<?php echo base_url(); ?>index.php/home/portfolio_export_COA?id=<?php echo $this->session->userdata('seeker_id')?>"/>
