...
<div id="register">
    ...
    <p>You can only accomplish a goal after you complete all its activities<br/>
        Some of your activities have not been completed, please try to finish them before you update your goal status.<br/> 
        Please <a href="<?php echo base_url();?>index.php/home/activity_list/"> View Activity</a></p>
</div>
<div id="home">
