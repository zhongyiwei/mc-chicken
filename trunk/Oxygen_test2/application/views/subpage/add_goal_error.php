...
<div id="register">
    ...
    <p>To have a balanced life, you should set goals in all key areas of life. <br/>
        There should not be more than 3 uncompleted in each goal category. <br/>
        Please finish the existing goals in this category first before you set another goal! Click to <a href="<?php echo base_url(); ?>index.php/home/see_goal/">View your Goals</a>!</p>
</div>
<div id="home">
