<!--     
    Author     : Wang Qianhua
    Description: Used to generate the page that displays the error message if users tried to access to "View Activity" which only members who logged 
...
<div id="register">
    ...
    <p style="padding-left: 20px;font-family:arial;color:green;font-size:12px">View Activity is only displayed to the Members. If you are not a member yet, please <a href="<?php echo base_url();?>index.php/login/register">Sign up</a> first!</p>
</div>
